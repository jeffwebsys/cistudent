...
$params['data'] = 'http://jefwebsys.com/caps/user/studentqr/'.$id;
$params['level'] = 'H';
$params['size'] = 3.5;
 ...
 ?>
                      ...
                      <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                         <a href="<?php echo site_url('user/students')?>"><button type="button" class="btn btn-success pull-left">Back</button></a>
