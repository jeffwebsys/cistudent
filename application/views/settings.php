                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo $row->admin_sitename; ?></td>
                         <td> <a href="<?php echo site_url('user/editsettings');?>/<?php echo $row->activity_id;?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Rename</a></td>
