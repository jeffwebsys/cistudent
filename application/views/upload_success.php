          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
               ...
               $sql = $this->db->query("SELECT * FROM tbl_users where user_id = '$id'");
               $sql2 = $sql->row(); ?>
                <img src="<?php echo base_url('uploads');?>/<?php echo $sql2->user_avatar; ?>" alt="..." class="img-circle profile_img">
              </div>
...
<!--Profile -->
      ...
      <ul> 
       ...
       <a href="<?php echo site_url('user/avatar')?>"><button type="button" class="btn btn-danger">Back</button></a>
