          ...
          <div class="nav_menu">
            <nav>
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <img src="<?php echo base_url('uploads')?>/<?php echo $sql2->user_avatar; ?>">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <button type="button" class="btn btn-primary pull-left" data-toggle="modal" data-target=".subject">
        Add Subject
        </button>
                    ...
                    <td>
                     <button class="btn btn-primary btn-xs editbtn" type="button"><i class="fa fa-edit"></i>Edit</button> | <a href="<?php echo site_url('user/deletesubject');?>/<?php echo $row->subject_id;?>" class="btn btn-danger btn-xs" onclick="return confirm('Are you sure you want to delete Subject: <?php echo $row->subject_name; ?> ?');"><i class="fa fa-trash-o"></i> Delete</a></td>
